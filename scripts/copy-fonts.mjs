 ...
 *
 * Solo se copian los subconjuntos latin y latin-ext del eje de peso (wght).
 * Las variantes "standard" y "opsz" del paquete incluyen ademas el eje de
 * tamano optico y pesan un 50% mas sin que el proyecto lo aproveche.
